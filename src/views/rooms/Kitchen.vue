<template>
  <div>
    ...
    <div v-if="!roomQuestions[1].answered" id='question-2' class='question'><router-link :to="{ name: 'question', params: {room: room.id, question: roomQuestions[1].relativeID } }"><div class='q-btn-active'></div></router-link></div>
    <div v-else id='question-2' class='question'><router-link :to="{ name: 'question', params: {room: room.id, question: roomQuestions[1].relativeID } }"><div class='q-btn-inactive'></div></router-link></div>
  </div>
</template>
...
export default {
  ...
  mounted: function () {
    ...
    var source = Marzipano.ImageUrlSource.fromString(
      '//waf.not-working.co.uk/unite-students/tiles/kitchen/{z}/{f}/{y}/{x}.jpg',
      { cubeMapPreviewUrl: '//waf.not-working.co.uk/unite-students/tiles/kitchen/preview.jpg' })
